...
class QuizController extends Controller
{
    ...
    public function startQuiz(Request $request) {
        ...
        // aceder à categoria e dificuldade passadas pelos inputs hidden na view home
        // caso utilizador nao selecione categoria, default é General Knowledge
        // caso utilizador nao selecione dificuldade, default é Medium
        $selectedCategory = $request->selectedCategory ?? 'General Knowledge';
        $selectedDifficulty = $request->selectedDifficulty ?? 'Medium';
