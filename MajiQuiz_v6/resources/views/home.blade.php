...
<div class="container">
    <div class="row justify-content-center" >
        <h1 class="display-1" style="text-align:center">@guest Hello, There! @else Hello, {{ Auth::user()['username'] }}! @endguest</h1>
                ...
                <p class="lead" style="text-align:center">
                    <a class="btn btn-warning btn-lg" href="{{ route('select-quiz') }}" role="button">@guest Try it out! @else Play! @endguest</a>
                </p>
